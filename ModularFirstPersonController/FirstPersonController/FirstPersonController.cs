...
public class FirstPersonController : Photon.MonoBehaviour
{
    ...
    private void Awake()
    {
        _skyboxManager = FindObjectOfType<SkyboxManager>();
        _skyboxManager.LoadSkybox();
    ...
    private void Start()
    {
        if (PhotonNetwork.isMasterClient)
            PhotonNetwork.masterClient.TagObject = gameObject;
    ...
    {
        if (_view.isMine)
            EventBus.escapeClicked += SetMovementEnable;
    }
    ...
    {
        //ItManager._players.Remove(gameObject);
        //print("Removed");
    }
    ...
    {
        cameraCanMove = enableJump = playerCanMove = lockCursor = enableZoom = enableCrouch = enable;
...
public class FirstPersonControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.photonEnable = EditorGUILayout.ToggleLeft(new GUIContent("Enable Photon", "Only with multiplayer"), fpc.photonEnable);
        ...
        fpc.rayDistance = EditorGUILayout.FloatField(new GUIContent("Ground Ray Distance"), fpc.rayDistance);
        GUI.enabled = true;
