...
public static class PhotonNetwork
{
    ...
    public static ServerConnection Server { get { return (PhotonNetwork.networkingPeer != null) ? PhotonNetwork.networkingPeer.Server : ServerConnection.NameServer; } set => Server = value; }
    ...
    public static bool ConnectUsingSettings(string gameVersion)
    {
        if (networkingPeer.PeerState != PeerStateValue.Disconnected)
        {
            Debug.LogError("ConnectUsingSettings() failed. Can only connect while in state 'Disconnected'. Current state: " + networkingPeer.PeerState);
            return false;
        }
        if (PhotonServerSettings == null)
        {
        ...
        if (offlineMode)
        {
            ...
            Debug.LogError("ConnectUsingSettings() disabled the offline mode. No longer offline.");
        }
    ...
    public static bool CreateRoom(string roomName, RoomOptions roomOptions, TypedLobby typedLobby, string[] expectedUsers)
    {
        ...
        {
            Debug.LogError("Server: " + networkingPeer.Server + "\t\tConnected and ready: " + connectedAndReady);
